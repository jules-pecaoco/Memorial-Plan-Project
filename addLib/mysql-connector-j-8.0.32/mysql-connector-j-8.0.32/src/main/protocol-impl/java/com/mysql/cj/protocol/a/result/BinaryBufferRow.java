...
public class BinaryBufferRow extends AbstractBufferRow {
    ...
    /**
     * The market position before the is-null bitmask for server-side prepared statement result sets
     */
     ...
     * columns hold null values, and sets the "market" position directly after the
     * bitmask.
     */
