 ...
 * 
 * <p>
 * Finally, create a 'UserUI.main' method that creates a new instance of your testcase, and calls the 'run' method:
 * 
 * <pre>
 * public static void UserUI.main(String[] args) throws Exception {
 *     new MyBugReport().run();
 * }
 * </pre>
 * 
